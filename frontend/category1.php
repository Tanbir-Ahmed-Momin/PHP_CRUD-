...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Exclusive Watch Collection for Female</h1>
        ...
        <div class="col">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/watch5.jpg" height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i12.jpg" height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/watch7.jpg"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i11.jpg"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/watch8.jpg"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/watch1.png"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            ...
                            <li class="page-item active">
                                <a class="page-link" href="category1.php">2 <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="page-item"><a class="page-link" href="category2.php">3</a></li>
                            <li class="page-item">
                                <a class="page-link" href="category.php">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
