...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Exclusive Watch Collection for Male</h1>
        ...
        <div class="col">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/w1.jpg" height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Smart Watch</a></h4>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i1.jpg" height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i8.png"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i16.jpeg"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Product title</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap</p>
                            <div class="row">
                                <div class="col">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/watch3.png"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="../public/asset/frontend/imagess/i8.jpg"height="300px" width="300px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product_details.php" title="View Product">Smart Watch</a></h4>
                            <p class="card-text">Sports Wristband TPE Watch Strap.</p>
                            <div class="row">
                ...
                <div class="col-12">
                    <nav aria-label="...">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link" href="category1.php">1</a></li>
                            <li class="page-item active">
                                <a class="page-link" href="category.php">2 <span class="sr-only">(current)</span></a>
                            </li>
