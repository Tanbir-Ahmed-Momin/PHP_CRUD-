                        ...
                        <div class="col-xl-6">
                            <div class="card-body p-md-5 text-black">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="tel" id="form3Example1n1"
                                                class="form-control form-control-lg" />
                                            <label class="form-label" for="form3Example1n1">Number</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <label class="form-label" for="form3Example9">mm/dd/yyyy</label>
                                </div>
                                ...
                                <div class="d-flex justify-content-end pt-3">
                                   ...
                                   <a href="../../index.php"> <button type="button" class="btn btn-warning btn-lg ms-2">Submit</button></a>
                                </div>
    ...
    <div class="container">
        <div class="row text-white g-4">
            <div class="col-md-6 col-lg-3">
                ...
                <p class="text-white text-muted mt-3">Time Travel watches are crafted from the finest raw materials and
