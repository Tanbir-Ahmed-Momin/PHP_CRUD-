                                        ...
                                        ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-flex">
                                                            <a href="./show.php?id=<?php echo $value['id'];?>" class="btn btn-sm btn-primary mx-1">View</a>
                                                            <a href="./edit.php?id=<?php echo $value['id'];?>" class="btn btn-sm btn-warning mx-1">Edit</a>
