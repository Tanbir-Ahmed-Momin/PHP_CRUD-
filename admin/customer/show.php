                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <!-- <a class="nav-link" href="../products/create_category.php">Create Category</a> -->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <p>&nbsp;/</p><a href="./index.php"  >&nbsp; Customers List</a>
                        ...
                        <div class="container">
                            <div class="row justifay-content-center">
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-header"><h3>View Customer</h3></div>
                                        <div class="card-body">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>01</td>
                                                        <td><?php echo $customres['name']?></td>
                                                        <!-- <td><img src="" alt="image not found"></td> -->
                                                        <td><?php echo $customres['email'];?></td>
                                                        <td><?php echo $customres['phone'];?></td>
                                                        <td><?php echo $customres['address'];?></td>
