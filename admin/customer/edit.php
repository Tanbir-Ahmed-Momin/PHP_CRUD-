...
session_start();
 ...
 $stmt = $pdo->query("SELECT * FROM customres WHERE id= $id");
 $customres = $stmt->fetch();
 ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <div class="nav">
                          ...
                          <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts3" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <!-- <a class="nav-link" href="./products/create_product.php">Add Product</a> -->
                                    <a class="nav-link" href="./index.php">Customer List</a>
                                </nav>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="hidden" class="form-control" name="id" id="id" value="<?= $id;?>">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" value="<?php echo $customres['name'];?>">
                                               
                                                </div>
                                                
                                                <div class="mb-3">
                                                    <label for="email">Customer Email:</label>
                                                    <input type="text" class="form-control" name="email" id="email" value="<?php echo $customres['email'];?>">
                                                    
                                                </div>
                                                <div class="mb-3">
                                                    <label for="phone">Customer Phone:</label>
                                                    <input type="text" class="form-control" name="phone" id="phone" value="<?php echo $customres['phone'];?>">
                                                    
                                                </div>
                                                <div class="mb-3">
                                                    <label for="address">Customer Address:</label>
                                                    <input type="text" class="form-control" name="address" id="address" value="<?php echo $customres['address'];?>">
                                                    
                                                </div>
                                                <!-- <div class="mb-3">
                                                    <label for="photo">Photo</label>
                                                <input type="file" class="form-control" name="photo" id="photo">
                                                <div><img src="" alt="not found"></div>
                                                </div> -->
                                                <div class="mb-3">
